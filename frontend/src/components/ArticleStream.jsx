...
const NVIDIA_Logo = () => (
    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-nvidia" xmlns="http://www.w3.org/2000/svg"><path d="M9.0 6.5v-.97C9.36 5.5 9.73 5.47 10.1 5.47c2.56 0 4.23 2.2 4.23 4.72 0 1.6-.64 3.06-1.77 4.03v1.15c1.84-.87 3.1-2.73 3.1-4.9 0-3.04-2.24-5.5-5-5.5-.56 0-1.1.09-1.63.26v1.27Zm0 8.16v1.1c-2.42-.6-4.2-2.8-4.2-5.4 0-2.5 1.67-4.63 3.97-5.35V3.8C6.3 4.57 4 7.1 4 10.2c0 3.35 2.56 6.1 5.8 6.44v-1.32c-.27-.06-.53-.14-.8-.26v-.43Zm0-6.32v5.43c.27.12.53.2.8.26V7.96c-.27.04-.53.1-.8.18v.2Z" /></svg>
);
